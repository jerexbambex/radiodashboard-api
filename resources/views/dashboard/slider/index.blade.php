	...
	<div class="main-content">
        @if(!$sliders->count())
            <div class="not-found-wrap text-center">
                ...
                <a class="btn btn-lg btn-primary btn-rounded" href="/slider/create">Start taking pictures</a>
            </div>
        @else
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-6 col-sm-12 ml-auto">
                    <a href="/slider/create" class="btn btn-rounded btn-primary btn-block mb-4">
                    ...
                    <div class="col-md-3">
    	                <div class="card card-profile-1 mb-4">
                            <div class="card-body text-center">
                                <div class="box-shadow-2 mb-3"><img src="{{ $slider->avatar }}" alt=""></div>
                                <div class="d-flex justify-content-around text-center col-12">
    	                            <form method="POST" action="{{ route('slider.destroy', $slider->path()) }}">
    	                            	@method('delete')
    	                            	@csrf
