                            ...
                            <form method="POST" action="{{ route('team.update', $team->path()) }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input class="form-control" id="firstName1" name="first_name" type="text" placeholder="Enter your first name" value="{{ $team->first_name }}">
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="lastName1">Last name</label>
                                        <input class="form-control" id="lastName1" name="last_name" type="text" placeholder="Enter your last name" value="{{ $team->last_name }}">
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <textarea class="form-control text-left" name="about" placeholder="A short bio about the new member">{{ $team->about }}</textarea>
                                    </div>
                                    <div class="col-md-6 form-group mb-3">
