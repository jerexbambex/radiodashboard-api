...
@section('content')
	<div class="main-content">
        ...
        <div class="row">
        	<div class="col-lg-4 col-md-6 col-sm-12">
                <div class="card card-icon mb-4">
                    <div class="card-body text-center"><i class="i-Data-Upload"></i>
                        <p class="text-muted mt-2 mb-2">Total posted events</p>
                        <p class="text-primary text-24 line-height-1 m-0">{{ $events->count() }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-6 col-sm-12 ml-auto">
                <a href="/event/create" class="btn btn-rounded btn-primary btn-block mb-4">
            ...
            <div class="col-md-12">
                <h4>List of all event members</h4>
            </div>
        </div>
	                ...
	                <div class="card card-profile-1 mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-around text-center col-12">
	                            <form method="POST" action="{{ route('event.destroy', $event->path()) }}">
	                            	@method('delete')
	                            	@csrf
	                            	<button type="submit" class="btn btn-default btn-rounded text-danger">Delete</button>
	                            </form>
	                            <a href="/event/{{ $event->path() }}/edit" class="btn btn-primary btn-rounded text-white">Edit</a>
	                        </div>
