                ...
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    <div class="card-body text-center"><i class="i-Add-User"></i>
                        <div class="content">
                            ...
                            <p class="text-primary text-24 line-height-1 mb-2">{{ $users->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    <div class="card-body text-center"><i class="i-Checkout-Basket"></i>
                        <div class="content">
                            ...
                            <p class="text-primary text-24 line-height-1 mb-2">{{ $schedules->count() }}</p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <table class="table text-center" id="user_table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <th scope="row">1</th>
                                                <td>Smith Doe</td>
                                                <td><img class="rounded-circle m-0 avatar-sm-table" src="admin/dist-assets/images/faces/1.jpg" alt="" /></td>
            ...
            <div class="col-lg-6 col-md-12">
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="admin/dist-assets/images/products/headphone-4.jpg" alt="" />
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="admin/dist-assets/images/products/headphone-2.jpg" alt="" />
                            <div class="flex-grow-1">
                        ...
                        <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-3"><img class="avatar-lg mb-3 mb-sm-0 rounded mr-sm-3" src="admin/dist-assets/images/products/headphone-3.jpg" alt="" />
                            <div class="flex-grow-1">
